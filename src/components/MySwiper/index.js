                    ...
                    <SwiperSlide>
                        <div className={ styles.card }>
                            ...
                            <Text bg={true} start={true}>
                                ...
                                <p>Pode ser para um simples final de semana que você queira sair da rotina ou para passar um feriado na praia...</p>
                    ...
                    <SwiperSlide>
                        <div className={ styles.card }>
                            ...
                            <Text bg={true} start={true}>
                                ...
                                <p><strong>No candeias você e sua família só terão alegria!</strong></p>
                                <p>São mais de cinco décadas de experiência e temos vários endereços fixos para eventuais problemas.</p>
                            </Text>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className={ styles.card }>
                            <h3>PREÇO IMBATÍVEL: ATÉ 60% DE ECONOMIA E PARCELE AINDA EM 12x SEM JUROS</h3>
                            <Text bg={true} start={true}>
                                <p>O Clube Candeias não tem fins lucrativos, por isso os preços das nossas diárias ficam bem a baixo dos preços particulares.</p>
                                <p>Nossas diárias são apenas para manter nossas unidades sempre confortáveis e agradáveis... e não para deixar proprietários ricos...</p>
                                <p>São mais de 40 Unidades próprias de norte a sul do país.</p>
                            </Text>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
