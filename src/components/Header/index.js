...
export default function Header({buttonClicked}) {
    return (
        <header className={ styles.header }>
            ...
            <HeroFlex buttonClicked={buttonClicked} head={true} img={ true } main="Viaje para os principais destinos do Brasil com até 40% de desconto" subtitle="Balneário Camboriú, Gramado, Rio de Janeiro, Florianópolis e até mesmo nos Estados Unidos, desfrutando dos melhores hotéis com descontos de até 40% nas hospedagens">
